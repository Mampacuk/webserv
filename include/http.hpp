...
namespace ft
{
	class http : public base_dir
	{
		...
		public:
			...
			static bool is_informational_code(code status);
			static bool is_successful_code(code status);
			static bool is_redirection_code(code status);
			static bool is_client_error_code(code status);
			static bool is_server_error_code(code status);
			static bool is_error_code(code status);
			static std::string reason_phrase(code status);
